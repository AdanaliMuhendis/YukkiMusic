...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/AdanaliMuhendis/ExtraPlugin",
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AdanaliMuhendis/YukkiMusic",
)
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/SohbetAlemi"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/ByCedric")
...
TG_AUDIO_FILESIZE_LIMIT = int(
    getenv("TG_AUDIO_FILESIZE_LIMIT", "21474836")
)  # Remember to give value in bytes

TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "214748364")
)  # Remember to give value in bytes
